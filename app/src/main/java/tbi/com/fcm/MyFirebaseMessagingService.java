...
import tbi.com.R;
import tbi.com.activity.SplashActivity;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private void notificationHandle(RemoteMessage remoteMessage) {
        ...
        // getData : {reminder_date=, reminder_time=, reminder_description=you are removed by Chetan, reference_id=, body=success, type=Sufferer_removed, title=Chetan removed you, click_action=ChatActivity, reminder_title=sufferer removed}
        // getData : {reminder_date=, reminder_time=, reminder_description=you are added by Chetan, reference_id=83, body=success, type=Sufferer_add, title=Chetan added you as a sufferer, click_action=ChatActivity, reminder_title=sufferer add}
        // getData : {reminder_date=, reminder_time=, reminder_description=you are added by Chetan, reference_id=84, body=success, type=Sufferer_add, title=Chetan added you as a sufferer, click_action=ChatActivity, reminder_title=sufferer add}// my caretaker remove
        //
        // getData : {reminder_date=2018-03-28, reminder_time=02:52 PM, reminder_description=Bxbnznxnxn, reference_id=261, body=success, type=Reminder_done, title=mindiiisuf done the reminder, click_action=ChatActivity, reminder_title=bxnxbbxxbnx}
        ...
        if (type != null && !type.equals("")) {
            if (type.equals("Reminder_add") | type.equals("Reminder_delete") | type.equals("Reminder_update")) {
                ...
                String intentType = "1";
                sendNotificationAddReminder(title, intentType);
            } else if (type.equals("Sufferer_removed")) {
                String reminder_description = remoteMessage.getData().get("reminder_description");
                String intentType = "2";
                sendNotificationAddReminder(reminder_description, intentType);
    ...
    private void sendNotificationAddReminder(String title, String intentType) {
        Intent intent = null;
        Session session = new Session(this);
        if (session.getIsLogedIn() && session.getUserType().equals("1")) {
