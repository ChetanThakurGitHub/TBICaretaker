package tbi.org.activity.main_activity;
...
import tbi.org.R;
import tbi.org.activity.NotificationRead;
import tbi.org.adapter.CaretakerNavigationAdapter;
import tbi.org.broadcastreceiver.activity.NetworkErrorActivity;
...
import tbi.org.fragment.caretaker.activity.EditProfileCaretakerActivity;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.iv_for_more:
                if (session.getLogin().equals("0")) {
                    Toast.makeText(this, "You are not connect with any TBI client to have chat with, first add TBI client", Toast.LENGTH_SHORT).show();
                } else {
                    iv_for_delete.setVisibility(View.GONE);
